  ...
  return (
    ...
    >
      <div className="flex items-center gap-2">
        ...
        <span className="inline-block transition-all duration-300 motion-reduce:transition-none group-hover:opacity-0">
          {children}
        </span>
      </div>
      ...
      <div
        aria-hidden="true"
        className="text-primary-foreground absolute top-0 z-10 flex h-full w-full translate-x-12 items-center justify-center gap-2 opacity-0 transition-all duration-300 motion-reduce:transition-none group-hover:opacity-100"
      >
        <span>{children}</span>
        <ArrowRight />
      </div>
