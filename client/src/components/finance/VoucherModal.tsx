...
export const VoucherModal: React.FC<VoucherModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-black/60 flex items-center justify-center p-4 print:p-0 print:bg-card print:static print:overflow-visible">
      {/* Container */}
      <div className="bg-card w-full max-w-3xl rounded-3xl shadow-xs border border-[#E9D9BF] overflow-hidden flex flex-col max-h-[92vh] print:max-h-none print:shadow-none print:border-none print:rounded-none">
