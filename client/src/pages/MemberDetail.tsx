          ...
          >
            <div className="mb-6 flex items-center justify-between gap-4">
              ...
              <button
                ...
                className="min-h-11 rounded-2xl border border-danger-soft bg-danger-soft px-3 py-2 text-xs font-bold text-danger disabled:opacity-50 cursor-pointer"
              >
                ปิดใช้งาน
              </button>
            </div>
            ...
            <button
              ...
              className="mt-5 inline-flex min-h-11 items-center gap-2 rounded-2xl bg-success px-5 py-2 text-sm font-bold text-white disabled:opacity-50"
            >
