  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto space-y-5 sm:space-y-6">
        ...
        <section className="bg-white rounded-2xl sm:rounded-2xl border border-[#DDE5F0] p-4 sm:p-6 md:p-8 shadow-xs relative overflow-hidden">
          <div className="absolute top-0 right-0 w-48 h-48 bg-gradient-to-bl from-[#12325C]/10 via-[#34D399]/10 to-transparent rounded-full blur-2xl pointer-events-none" />
          ...
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-6 text-center sm:text-left relative z-10">
            ...
            <div className="relative shrink-0">
              {effectiveAvatar ? (
                ...
                <div className="w-20 h-20 sm:w-24 sm:h-24 md:w-28 md:h-28 rounded-full bg-gradient-to-br from-[#FEF3C7] to-[#12325C]/25 border-4 border-white shadow-md flex items-center justify-center text-[#475569] font-bold text-2xl sm:text-3xl md:text-4xl select-none">
                  {user?.name ? user.name.slice(0, 1) : "ศ"}
                </div>
              )}
              <div className="absolute bottom-0.5 right-0.5 sm:bottom-1 sm:right-1 w-6 h-6 sm:w-7 sm:h-7 rounded-full bg-[#34D399] border-2 border-white flex items-center justify-center shadow-xs">
            ...
            <div className="flex-1 min-w-0 space-y-2">
              <div className="space-y-1">
                <div className="flex flex-wrap items-center justify-center sm:justify-start gap-2">
                  <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-[#0C1B33] tracking-tight break-words">
                    {user?.name || "ผู้ใช้งานระบบ"}
                  </h2>
                </div>
                <p className="text-xs sm:text-sm font-semibold text-[#475569] flex items-center justify-center sm:justify-start gap-1.5 flex-wrap">
                  <Building className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#12325C] shrink-0" />
                  <span>
                    {(user as any)?.department || "สมาชิกครอบครัวของพระเจ้า"}
                  </span>
                </p>
                <div className="flex flex-wrap items-center justify-center sm:justify-start gap-3 text-[11px] sm:text-xs text-[#64748B]">
                ...
                {(user as any)?.bio && (
                  <p className="text-xs text-[#64748B] italic pt-1 max-w-lg">
                    "{(user as any)?.bio}"
                  </p>
                )}
              </div>
          ...
          {/* ── Action Buttons ───────────────────────────────────────────────── */}
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 sm:gap-3 mt-5 sm:mt-6 pt-5 sm:pt-6 border-t border-[#DDE5F0]/60">
            <button
              onClick={() => setShowIdCardModal(true)}
              className="w-full min-h-11 sm:min-h-12 py-2.5 sm:py-3 px-3 sm:px-5 rounded-2xl bg-[#EDF1F7] hover:bg-[#FEF3C7] text-[#475569] font-bold text-xs sm:text-sm border border-[#DDE5F0] shadow-xs flex items-center justify-center gap-2 transition-all active:scale-[0.98]"
            >
              <QrCode className="w-4 h-4 text-[#12325C] shrink-0" />
            ...
            <button
              ...
              className="w-full min-h-11 sm:min-h-12 py-2.5 sm:py-3 px-3 sm:px-5 rounded-xl bg-[#12325C] hover:bg-[#0F2947] text-white font-bold text-xs sm:text-sm shadow-xs flex items-center justify-center gap-2 transition-all active:scale-[0.98]"
            >
        ...
        {canCountOfferings(user) && (
          <section className="bg-gradient-to-r from-[#F6F8FC] to-[#EDF1F7] rounded-2xl sm:rounded-2xl border border-[#DDE5F0] p-4 sm:p-6 shadow-xs flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <button
              ...
              className="min-h-11 px-5 py-2.5 rounded-xl bg-[#12325C] hover:bg-[#0F2947] text-white font-bold text-xs sm:text-sm shadow-xs flex items-center gap-2 shrink-0 transition-transform active:scale-95"
            >
        ...
        <section className="bg-white rounded-2xl sm:rounded-2xl border border-[#DDE5F0] p-4 sm:p-6 md:p-8 space-y-4 sm:space-y-6 shadow-xs">
          <div className="border-b border-[#DDE5F0]/60 pb-3 sm:pb-4">
            <span className="inline-flex items-center gap-1.5 px-3 py-0.5 rounded-full text-xs font-bold bg-[#EDF1F7] text-[#475569] border border-[#DDE5F0] mb-2">
              <Award className="w-3.5 h-3.5 text-[#12325C]" />
              มติคริสตจักรอย่างเป็นทางการ
            </span>
            <h3 className="text-lg sm:text-xl font-bold text-[#0C1B33]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {OFFICIAL_CHURCH_ROSTER.map((roster, idx) => (
              <div
                key={roster.role}
                className="rounded-2xl border border-[#DDE5F0] bg-[#FFFFFF] hover:bg-white p-4 sm:p-5 space-y-3 transition-all hover:shadow-xs flex flex-col justify-between"
              >
                <div className="space-y-2">
                  ...
                  <div className="pt-2 border-t border-[#DDE5F0]/50">
                    ...
                    <ul className="space-y-1">
                      {roster.responsibilities.map((resp, rIdx) => (
                        <li
                          key={rIdx}
                          className="text-xs text-[#0C1B33] flex items-start gap-1.5"
                        >
        ...
        <section className="rounded-2xl sm:rounded-2xl border border-[#DDE5F0] bg-white p-4 sm:p-6 md:p-8 shadow-xs space-y-4">
          <h3 className="text-base font-bold text-[#0C1B33]">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div className="text-xs sm:text-sm text-[#475569]">
              <p>
                เข้าสู่ระบบโดย:{" "}
                <strong className="text-[#0C1B33] font-bold">
      ...
      {showIdCardModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/50 backdrop-blur-xs animate-in fade-in duration-200">
          <div className="bg-white rounded-2xl sm:rounded-2xl border border-[#DDE5F0] max-w-sm sm:max-w-md w-full p-4 sm:p-6 md:p-8 space-y-4 sm:space-y-6 shadow-2xl relative max-h-[92vh] overflow-y-auto overscroll-contain">
            <button
              onClick={() => setShowIdCardModal(false)}
              className="absolute top-4 right-4 sm:top-5 sm:right-5 p-2 rounded-full hover:bg-slate-100 text-[#475569] transition-colors min-h-10 min-w-10 flex items-center justify-center"
            ...
            <div className="text-center space-y-1 pt-1 sm:pt-2">
              <span className="px-3 py-0.5 sm:py-1 rounded-full text-[10px] sm:text-[11px] font-bold bg-[#E6F6EE] text-[#047857] uppercase tracking-wider">
                Digital Church Member Card
              </span>
              <h3 className="text-lg sm:text-xl font-bold text-[#0C1B33] pt-1">
                บัตรประจำตัวคริสตจักร
              </h3>
              <p className="text-xs text-[#475569]">{churchName}</p>
            </div>

            {/* ID Card Box */}
            <div className="p-4 sm:p-6 rounded-2xl sm:rounded-2xl bg-gradient-to-br from-[#EDF1F7] via-[#F6F8FC] to-[#FEF3C7] border-2 border-[#DDE5F0] shadow-sm text-center space-y-3 sm:space-y-4">
              {effectiveAvatar ? (
                <img
                  src={effectiveAvatar}
                  alt={user?.name || "Member Avatar"}
                  className="w-16 h-16 sm:w-20 sm:h-20 mx-auto rounded-full object-cover shadow-md border-3 border-[#12325C]"
                />
              ) : (
                <div className="w-16 h-16 sm:w-20 sm:h-20 mx-auto rounded-full bg-white shadow-md border-3 border-[#12325C] flex items-center justify-center text-2xl sm:text-3xl font-bold text-[#475569]">
                  {user?.name ? user.name.slice(0, 1) : "ศ"}
                </div>
              )}
              <div className="space-y-0.5 sm:space-y-1">
                <h4 className="text-base sm:text-lg font-bold text-[#0C1B33] break-words">
              ...
              {/* QR Code */}
              <div className="p-3 sm:p-4 bg-white rounded-2xl border border-[#DDE5F0] inline-block shadow-2xs">
                <QrCode className="w-24 h-24 sm:w-28 sm:h-28 text-[#0C1B33] mx-auto" />
                <p className="text-[10px] text-[#64748B] font-mono mt-1 font-bold">
                  ID: GL-
                  {user?.id ? user.id.toString().padStart(5, "0") : "00001"}
                </p>
              </div>

              <div className="grid grid-cols-2 gap-2 text-left pt-2 border-t border-[#DDE5F0]/70 text-xs">
                <div>
                  <span className="text-[10px] text-[#64748B]">
                    สังกัดคริสตจักร:
                  </span>
                  <p className="font-bold text-[#0C1B33] truncate">
                    {churchName}
                  </p>
                </div>
                <div>
            ...
            <div className="flex gap-2">
              <button
                ...
                className="flex-1 min-h-11 py-2.5 rounded-2xl bg-[#EDF1F7] border border-[#DDE5F0] text-[#475569] font-bold text-xs sm:text-sm hover:bg-[#FEF3C7] transition-all flex items-center justify-center gap-1.5"
              >
              ...
              <button
                onClick={() => setShowIdCardModal(false)}
                className="flex-1 min-h-11 py-2.5 rounded-2xl bg-[#0C1B33] text-white font-bold text-xs sm:text-sm hover:bg-[#0C1B33] transition-all"
              >
                ปิดหน้าต่าง
              </button>
            </div>
      ...
      {showEditProfileModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/50 backdrop-blur-xs animate-in fade-in duration-200">
          <div className="bg-white rounded-2xl sm:rounded-2xl border border-[#DDE5F0] max-w-sm sm:max-w-md w-full p-4 sm:p-6 md:p-8 space-y-4 sm:space-y-5 shadow-2xl relative max-h-[92vh] overflow-y-auto overscroll-contain">
            <button
            ...
            >
              <div className="space-y-1.5">
                <label className="text-xs font-bold text-[#0C1B33]">
                ...
                <input
                  ...
                  className="w-full px-3.5 sm:px-4 py-2.5 sm:py-3 rounded-2xl border border-[#DDE5F0] text-xs sm:text-sm font-semibold text-[#0C1B33] focus:border-[#12325C] focus:outline-none focus:ring-2 focus:ring-[#12325C]/20 transition-all"
                    ...
                    {PRESET_AVATARS.map((p, i) => (
                      <button
                        ...
                        className={`w-7 h-7 rounded-full overflow-hidden border-2 transition-all ${
                          editAvatarUrl === p
                            ? "border-[#12325C] scale-110 shadow-xs"
                            : "border-transparent"
                        }`}
                      >
                        <img
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-2.5 rounded-2xl border border-[#DDE5F0] text-xs font-semibold text-[#0C1B33] focus:border-[#12325C] focus:outline-none"
              ...
              <div className="space-y-1.5">
                ...
                <textarea
                  ...
                  className="w-full px-3.5 py-2.5 rounded-2xl border border-[#DDE5F0] text-xs font-semibold text-[#0C1B33] focus:border-[#12325C] focus:outline-none resize-none"
                  placeholder="เช่น ผู้ให้ด้วยใจยินดี พระเจ้าทรงรัก (2 โครินธ์ 9:7)"
                />
              </div>

              <div className="p-3 sm:p-3.5 rounded-2xl bg-[#F6F8FC] border border-[#DDE5F0]/60 text-xs text-[#64748B] space-y-1">
              ...
              <div className="flex items-center gap-2.5 sm:gap-3 pt-1 sm:pt-2">
                <button
                  type="button"
                  onClick={() => setShowEditProfileModal(false)}
                  className="flex-1 min-h-11 py-2.5 sm:py-3 rounded-2xl border border-[#DDE5F0] text-xs sm:text-sm font-bold text-[#475569] hover:bg-[#F6F8FC] transition-all"
                >
                  ยกเลิก
                </button>
                <button
                  type="submit"
                  disabled={isSaving}
                  className="flex-1 min-h-11 py-2.5 sm:py-3 rounded-2xl bg-[#12325C] hover:bg-[#0F2947] text-white text-xs sm:text-sm font-bold shadow-xs transition-all disabled:opacity-50 active:scale-[0.98]"
                >
