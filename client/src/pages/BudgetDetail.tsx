        ...
        {!validId ? (
          ...
          <>
            <section className="rounded-2xl border border-[#DDE5F0] bg-white p-6 shadow-sm md:p-8">
              <h1 className="text-2xl font-bold text-[#0C1B33]">
              ...
              <dl className="mt-5 grid grid-cols-3 gap-3">
                <div>
                  <dt className="text-xs text-[#64748B]">งบประมาณ</dt>
                  <dd>
                    <MoneyDisplay amount={query.data.plannedAmount} size="sm" />
                  </dd>
                </div>
                <div>
                  <dt className="text-xs text-[#64748B]">ใช้จริง</dt>
                  <dd>
                ...
                <div>
                  ...
                  <dd>
                    <MoneyDisplay
                      ...
                      size="sm"
                      className={
                        query.data.remainingAmount < 0 ? "!text-[#B91C1C]" : ""
                      }
                    />
                  </dd>
                </div>
            ...
            <form
              onSubmit={submit}
              className="rounded-2xl border border-[#DDE5F0] bg-white p-6 shadow-sm md:p-8"
            >
              <div className="mb-5 flex flex-wrap items-center justify-between gap-3">
                <h2 className="font-bold text-[#0C1B33]">แก้ไขงบประมาณ</h2>
                <button
                  type="button"
              ...
              <button
                ...
                className="mt-6 min-h-11 inline-flex items-center gap-2 rounded-xl bg-[#047857] px-5 py-2 text-sm font-bold text-white disabled:opacity-50"
              >
            ...
            <section className="rounded-2xl border border-[#DDE5F0] bg-white p-6 shadow-sm md:p-8">
              ...
              {query.data.expenses.length === 0 ? (
                ...
                <ul className="mt-3 divide-y divide-[#DCE4F0]">
                  {query.data.expenses.map(expense => (
                    ...
                    >
                      <div className="min-w-0">
                        <p className="truncate text-sm font-semibold text-[#0C1B33]">
                          {expense.description}
                        </p>
                      ...
                      <span className="shrink-0 text-sm font-bold tabular-nums text-[#0C1B33]">
