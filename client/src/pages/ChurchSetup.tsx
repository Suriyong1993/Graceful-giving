...
function FieldLabel({ children, required, htmlFor }: { children: React.ReactNode; required?: boolean; htmlFor?: string }) {
  return (
    <label htmlFor={htmlFor} className="mb-1.5 block text-xs font-bold text-[#5a463a]">
...
function Step2({ data, set }: { data: SetupData; set: (p: Partial<SetupData>) => void }) {
  return (
    <div className="space-y-4">
      ...
      <div>
        <FieldLabel htmlFor="church-motto">ข้อพระคัมภีร์หรือคติพจน์ของคริสตจักร</FieldLabel>
        <textarea
          id="church-motto"
