...
export function HeroSection() {
  return (
    <section
      ...
      className="animate-fade-up relative rounded-2xl overflow-hidden bg-white border border-[#E4DED7] card-elevation-sm p-6 sm:p-8 md:p-10 w-full"
    >
      {/* Hero Content Grid */}
        ...
        <div className="min-w-0 md:col-span-7 space-y-4 w-full flex flex-col justify-center">
          ...
          <h1 className="flex flex-col">
            <span className="flex items-center gap-2 sm:gap-3">
              <span className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-[#1F1A17] tracking-tight leading-none font-display">
                Grace
              </span>
          ...
          <div className="inline-flex flex-wrap items-center gap-2 sm:gap-3 px-3.5 py-2 rounded-xl bg-[#FFFFFF] border border-[#E4DED7] text-xs sm:text-sm text-[#1F1A17] max-w-full">
            <span className="whitespace-nowrap font-bold text-[#A34A0C] shrink-0">
              2 โครินธ์ 9:7
            </span>
