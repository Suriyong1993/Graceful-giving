...
export function FinancialSummaryRow({
  ...
  return (
    ...
    >
      ...
      <div className="min-w-0 bg-card border border-[#C3E4B8] rounded-2xl p-5 sm:p-6 flex sm:flex-col items-center sm:items-start gap-4 shadow-xs hover:border-[#A3D995] transition-colors">
      ...
      <div className="min-w-0 bg-card border border-[#F8C8C5] rounded-2xl p-5 sm:p-6 flex sm:flex-col items-center sm:items-start gap-4 shadow-xs hover:border-[#F2A49F] transition-colors">
      ...
      {/* Card 3: คงเหลือ (Net) */}
      <div
        className={`min-w-0 bg-card rounded-2xl p-5 sm:p-6 flex sm:flex-col items-center sm:items-start gap-4 border shadow-xs sm:col-span-2 lg:col-span-1 transition-colors ${isPositiveNet ? "border-[#E9D9BF] hover:border-[#D47012]" : "border-[#F8C8C5] hover:border-[#F2A49F]"}`}
      >
        <div
