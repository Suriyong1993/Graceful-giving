        ...
        {showCreate && (
          ...
          >
            <div className="mb-5 flex items-center justify-between">
              <h2 className="font-bold text-[#0C1B33]">เพิ่มสมาชิกใหม่</h2>
              <button
                type="button"
            ...
            {membersQuery.data.map(member => (
              ...
              >
                <div className="flex items-center justify-between gap-3">
                  <h2 className="font-bold text-[#0C1B33]">{member.name}</h2>
                  <span
                    className={`rounded-full px-2 py-1 text-[11px] ${member.status === "active" ? "bg-[#E6F6EE] text-[#0C1B33]" : "bg-slate-100 text-slate-600"}`}
                  >
