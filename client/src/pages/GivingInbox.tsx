      ...
      action={
        <div className="flex flex-wrap items-center gap-2">
          ...
          <button
            ...
            className="px-3.5 py-2 rounded-2xl bg-white border border-[#DDE5F0] text-[#475569] hover:bg-[#EDF1F7] text-xs font-bold transition-all flex items-center gap-1.5 shadow-2xs"
            title="ดูสมุดบัญชีเงินถวายที่อนุมัติแล้ว"
          >
            <BookOpen className="w-3.5 h-3.5 text-[#12325C]" />
          ...
          >
            <QrCode className="w-3.5 h-3.5 text-[#047857]" />
          ...
          <button
            ...
            className="px-4 py-2 rounded-xl bg-[#12325C] hover:bg-[#0F2947] text-white text-xs font-bold button-elevation transition-all flex items-center gap-1.5 shadow-xs"
          >
          ...
          <button
            ...
            className="p-2 rounded-2xl bg-white border border-[#DDE5F0] text-[#475569] hover:bg-[#EDF1F7] transition-all shadow-2xs cursor-pointer"
    ...
    >
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-5 gap-3">
          <button
            ...
            className={`min-h-11 p-3.5 rounded-xl border transition-all text-left ${
              selectedStatus === "needs_review"
                ...
                : "bg-white border-[#DDE5F0] hover:bg-[#FFFFFF]"
            }`}
          >
          ...
          <button
            ...
            className={`min-h-11 p-3.5 rounded-xl border transition-all text-left ${
              selectedStatus === "approved"
                ? "bg-slate-100 border-slate-400 shadow-2xs ring-2 ring-slate-400/20"
                : "bg-white border-[#DDE5F0] hover:bg-[#FFFFFF]"
            }`}
          >
            <div className="flex items-center justify-between">
          ...
          <button
            ...
            className={`min-h-11 p-3.5 rounded-xl border transition-all text-left col-span-2 sm:col-span-1 ${
              selectedStatus === "all"
                ? "bg-[#EDF1F7] border-[#12325C] shadow-2xs ring-2 ring-[#12325C]/20"
                : "bg-white border-[#DDE5F0] hover:bg-[#FFFFFF]"
            }`}
          >
            <div className="flex items-center justify-between">
              ...
              <Inbox className="w-4 h-4 text-[#475569]" />
            </div>
            <div className="text-2xl font-bold text-[#0C1B33] mt-1 tabular-nums">
              {stats?.total ?? 0}
            </div>
          </button>
        </div>
        ...
        {totalSlips === 0 && !slipsQuery.isLoading && (
          <div className="bg-gradient-to-br from-white via-[#FFFFFF] to-[#EDF1F7] rounded-2xl border-2 border-[#DDE5F0] p-6 sm:p-8 shadow-sm">
            <div className="max-w-3xl mx-auto space-y-6 text-center sm:text-left">
              <div className="flex flex-col sm:flex-row items-center gap-5">
                <div className="w-16 h-16 rounded-2xl bg-[#047857]/15 border-2 border-[#047857]/30 flex items-center justify-center text-[#047857] shrink-0">
                  <Sparkles className="w-8 h-8" />
                </div>
                <div>
                  <h3 className="text-xl sm:text-2xl font-bold text-[#0C1B33]">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-2">
                <div className="p-4 rounded-2xl bg-white border border-[#DDE5F0] space-y-2">
                  <div className="w-8 h-8 rounded-xl bg-[#12325C]/20 text-[#12325C] font-bold text-sm flex items-center justify-center">
                    1
                  </div>
                  <h4 className="font-bold text-sm text-[#0C1B33]">
                ...
                <div className="p-4 rounded-2xl bg-white border border-[#DDE5F0] space-y-2">
                  <div className="w-8 h-8 rounded-xl bg-[#047857]/20 text-[#047857] font-bold text-sm flex items-center justify-center">
                    2
                  </div>
                  <h4 className="font-bold text-sm text-[#0C1B33]">
              ...
              <div className="flex flex-wrap items-center justify-center sm:justify-start gap-3 pt-2">
                <button
                  type="button"
                  onClick={() => setShowUploadModal(true)}
                  className="px-6 py-3 rounded-xl bg-[#12325C] hover:bg-[#0F2947] text-white font-bold text-sm shadow-md transition-all flex items-center gap-2"
                >
                  <UploadCloud className="w-4 h-4" />{" "}
                ...
                <button
                  type="button"
                  onClick={() => setShowLineInfoModal(true)}
                  className="px-5 py-3 rounded-2xl bg-white border border-[#DDE5F0] text-[#475569] hover:bg-[#EDF1F7] font-bold text-sm transition-all flex items-center gap-2"
                >
                  <QrCode className="w-4 h-4 text-[#047857]" /> ดูวิธีเชื่อมต่อ
                  LINE OA
                </button>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          ...
          <div className="lg:col-span-5 space-y-4">
            {/* Search and Filters */}
            <div className="bg-white rounded-2xl border border-[#DDE5F0] p-3 shadow-2xs flex items-center gap-2">
              <Search className="w-4 h-4 text-[#64748B] ml-2" />
              <input
                type="text"
                placeholder="ค้นหาชื่อผู้โอน, สมาชิก, ยอดเงิน..."
                value={searchQuery}
                onChange={e => setSearchQuery(e.target.value)}
                className="min-h-11 w-full text-base md:text-sm bg-transparent border-0 focus:outline-none text-[#0C1B33]"
              />
            </div>

            {/* Slips Cards */}
            {slipsQuery.isLoading ? (
              <div className="p-12 text-center text-sm text-[#64748B] bg-white rounded-2xl border border-[#DDE5F0]">
                กำลังโหลดรายการสลิป...
              </div>
            ) : filteredSlips.length === 0 ? (
              <div className="p-12 text-center text-[#64748B] bg-white rounded-2xl border border-[#DDE5F0] space-y-3">
                ...
                <button
                  type="button"
                  onClick={() => setShowUploadModal(true)}
                  className="min-h-11 inline-flex items-center gap-1.5 px-4 py-2 rounded-xl bg-[#EDF1F7] border border-[#DDE5F0] text-[#475569] text-xs font-bold hover:bg-[#FEF3C7] transition-all"
                >
                  ...
                  return (
                    <div
                      ...
                      className={`p-4 rounded-2xl border cursor-pointer transition-all ${
                        isSelected
                          ? "bg-[#EDF1F7] border-[#12325C] shadow-md ring-2 ring-[#12325C]/20"
                          : "bg-white border-[#DDE5F0] hover:bg-[#FFFFFF] hover:border-[#12325C]/50 shadow-2xs"
                      }`}
                    >
                      <div className="flex items-start justify-between gap-3">
                        <div className="flex items-center gap-3 min-w-0">
                          {slip.signedImageUrl ? (
                            <img
                              ...
                              alt="สลิป"
                              className="w-14 h-14 object-cover rounded-xl border border-[#DDE5F0] shrink-0 bg-slate-100"
                            />
                          ) : (
                            <div className="w-14 h-14 rounded-xl bg-slate-100 border border-[#DDE5F0] flex items-center justify-center text-slate-400 shrink-0">
                              <CreditCard className="w-6 h-6" />
                            </div>
                          )}
                          <div className="min-w-0">
                            <div className="font-bold text-base text-[#0C1B33] truncate">
                              {slip.matchedMemberName ||
                                slip.extractedSenderName ||
                                slip.lineDisplayName ||
                                "ผู้ถวาย"}
                            </div>
                            <div className="text-xs text-[#64748B] flex items-center gap-1.5 mt-0.5 truncate">
                        ...
                        <div className="text-right shrink-0">
                          <div className="text-lg font-bold text-[#12325C]">
                      ...
                      <div className="flex items-center justify-between mt-3 pt-2.5 border-t border-[#DDE5F0]/50 text-xs text-[#64748B]">
          ...
          <div className="lg:col-span-7">
            {!selectedSlipId || !currentSlip ? (
              <div className="p-12 text-center bg-white rounded-2xl border border-dashed border-[#DDE5F0] text-[#64748B] space-y-3 min-h-[420px] flex flex-col items-center justify-center">
                <Inbox className="w-12 h-12 text-[#12325C]/50" />
                <div className="font-bold text-base text-[#0C1B33]">
              ...
              <div className="bg-white rounded-2xl border border-[#DDE5F0] p-5 sm:p-6 shadow-xs space-y-6 animate-in fade-in duration-150">
                {/* Header of Detail */}
                <div className="flex items-start justify-between gap-4 pb-4 border-b border-[#DDE5F0]">
                  <div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    {currentSlip.signedImageUrl && (
                      <a
                        ...
                        className="min-h-11 px-3 py-1.5 rounded-xl border border-[#DDE5F0] bg-[#EDF1F7] text-xs font-bold text-[#475569] hover:bg-[#FEF3C7] inline-flex items-center gap-1.5 transition-colors"
                      >
                        <ExternalLink className="w-3.5 h-3.5" /> ดูภาพเต็ม
                      </a>
                    )}
                  </div>
                  <div className="rounded-xl border border-[#DDE5F0] overflow-hidden bg-slate-50 max-h-[340px] flex items-center justify-center p-2">
                    {currentSlip.signedImageUrl ? (
                      <img
                ...
                <div className="space-y-3 bg-[#FFFFFF] border border-[#DDE5F0] p-4 rounded-xl text-xs">
                  <div className="flex flex-wrap items-center justify-between gap-2 pb-2 border-b border-[#DDE5F0]/50">
                    <div className="font-bold text-sm text-[#0C1B33] flex items-center gap-1.5">
                      <Sparkles className="w-4 h-4 text-[#12325C]" />
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 pt-1">
                    <div className="p-2.5 rounded-lg bg-white border border-[#DDE5F0]/60">
                      <span className="text-slate-500 block text-[11px]">
                        ยอดเงินที่ตรวจพบ
                      </span>
                      <span className="text-base font-bold text-[#12325C] tabular-nums block mt-0.5">
                    ...
                    <div className="p-2.5 rounded-lg bg-white border border-[#DDE5F0]/60">
                      ...
                      <span className="text-xs font-bold text-[#0C1B33] block mt-1 truncate">
                        {currentSlip.extractedSenderName || "—"}
                      </span>
                    </div>
                    ...
                    <div className="p-2.5 rounded-lg bg-white border border-[#DDE5F0]/60">
                      ...
                      <span className="text-xs font-medium text-[#0C1B33] block mt-1 truncate">
                ...
                <div className="space-y-4 pt-2 border-t border-[#DDE5F0]">
                  <div className="flex items-center justify-between">
                    <h3 className="text-xs font-bold text-[#475569] uppercase tracking-wider">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-1.5">
                        ...
                        {currentSlip.lineUserId &&
                          ...
                          !currentSlip.lineUserId.startsWith("manual-") && (
                            <button
                              ...
                              className="text-[11px] text-[#047857] hover:underline flex items-center gap-1 font-semibold"
                            >
                      ...
                      <NativeSelect
                        ...
                        className="focus:ring-2 focus:ring-[#12325C]"
                      >
                        <option value="">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <NativeSelect
                        ...
                        disabled={currentSlip.status === "approved"}
                        className="focus:ring-2 focus:ring-[#12325C] font-medium"
                      >
                    ...
                    <div className="space-y-1.5">
                      ...
                      <input
                        ...
                        disabled={currentSlip.status === "approved"}
                        className="min-h-11 w-full text-base font-bold tabular-nums text-[#12325C] rounded-xl border border-[#DDE5F0] bg-white p-2.5 focus:ring-2 focus:ring-[#12325C] focus:outline-none"
                      />
                    </div>
                  ...
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      disabled={currentSlip.status === "approved"}
                      className="min-h-11 w-full text-sm rounded-xl border border-[#DDE5F0] bg-white p-2.5 focus:ring-2 focus:ring-[#12325C] focus:outline-none"
                    />
                  </div>
                </div>
                ...
                {currentSlip.status !== "approved" &&
                currentSlip.status !== "rejected" ? (
                  <div className="space-y-3 pt-4 border-t border-[#DDE5F0]">
                    {currentSlip.status === "duplicate" && (
                    ...
                    <div className="flex flex-col-reverse sm:flex-row items-center justify-end gap-3">
                      ...
                      <button
                        ...
                        className="min-h-11 w-full sm:w-auto px-7 py-2.5 rounded-xl bg-[#047857] hover:bg-[#064E3B] text-white font-bold text-sm shadow-xs transition-colors flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50"
                      >
                        {approveMutation.isPending ? (
                          <>
      ...
      {showUploadModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-xs animate-in fade-in">
          <div className="bg-white rounded-2xl border-2 border-[#DDE5F0] p-6 max-w-lg w-full space-y-5 shadow-2xl relative">
            <button
              onClick={() => {
                setShowUploadModal(false);
                setUploadPreview(null);
            ...
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-2xl bg-[#12325C]/20 text-[#12325C] flex items-center justify-center">
                <UploadCloud className="w-5 h-5" />
              </div>
              <div>
                <h3 className="text-lg font-bold text-[#0C1B33]">
            ...
            <div
              ...
              className={`border-2 border-dashed rounded-2xl p-6 text-center cursor-pointer transition-all ${
                uploadPreview
                  ? "border-[#12325C] bg-[#F6F8FC]"
                  : "border-[#DDE5F0] hover:border-[#12325C] bg-slate-50"
              }`}
            >
              <input
                ref={fileInputRef}
              ...
              {uploadPreview ? (
                <div className="space-y-3">
                  ...
                  />
                  <p className="text-xs text-[#12325C] font-bold">
                ...
                <div className="space-y-2 py-4">
                  ...
                  <p className="font-bold text-sm text-[#0C1B33]">
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full text-sm rounded-xl border border-[#DDE5F0] p-2.5 focus:ring-2 focus:ring-[#12325C] focus:outline-none"
              />
            </div>
            ...
            <div className="flex items-center justify-end gap-3 pt-2">
              <button
                ...
                className="px-5 py-2.5 rounded-2xl border border-[#DDE5F0] text-[#475569] font-bold text-sm hover:bg-slate-50"
              >
                ยกเลิก
              </button>
              <button
                ...
                className="px-6 py-2.5 rounded-xl bg-[#12325C] hover:bg-[#0F2947] text-white font-bold text-sm shadow-md disabled:opacity-50 flex items-center gap-2"
              >
      ...
      {showLineInfoModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-xs animate-in fade-in">
          <div className="bg-white rounded-2xl border-2 border-[#DDE5F0] p-6 max-w-lg w-full space-y-5 shadow-2xl relative">
            ...
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-2xl bg-[#047857]/20 text-[#047857] flex items-center justify-center">
            ...
            {/* Webhook URL Box */}
            <div className="bg-slate-50 border border-[#DDE5F0] p-3.5 rounded-2xl space-y-1.5">
              ...
              <div className="font-mono text-xs bg-white p-2 rounded-xl border border-[#DDE5F0] text-[#0C1B33] break-all select-all">
                https://graceful-giving.vercel.app/api/line/webhook
              </div>
            </div>

            {/* Instructions */}
            <div className="space-y-3 text-xs text-[#1E4470]">
            ...
            <div className="flex justify-end pt-2">
              <button
                type="button"
                onClick={() => setShowLineInfoModal(false)}
                className="px-6 py-2.5 rounded-xl bg-[#12325C] text-white font-bold text-sm shadow-xs hover:bg-[#0F2947]"
              >
                เข้าใจแล้ว
              </button>
            </div>
      ...
      <Dialog open={showRejectModal} onOpenChange={setShowRejectModal}>
        <DialogContent className="max-w-md bg-white border border-[#DDE5F0] rounded-2xl p-6 text-[#0C1B33] space-y-4 shadow-xl">
          <DialogHeader className="space-y-1 text-left">
            <DialogTitle className="text-lg font-bold text-[#0C1B33] flex items-center gap-2">
          ...
          <div className="space-y-1.5">
            <label
              ...
              className="text-xs font-bold text-[#475569] block"
            >
            ...
            <textarea
              ...
              className="w-full text-sm rounded-xl border border-[#DDE5F0] p-3 focus:outline-none focus:ring-2 focus:ring-rose-400 resize-none"
            />
          </div>
