    ...
    <AppLayout
      ...
      action={
        <button
          ...
          className="min-h-11 inline-flex items-center gap-2 rounded-xl bg-[#12325C] px-4 py-2.5 text-sm font-bold text-white shadow-sm transition-colors hover:bg-[#0F2947]"
        >
    ...
    >
      <div className="space-y-6">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div
            className="flex items-center gap-1 rounded-xl border border-[#DDE5F0] bg-white p-1"
            role="group"
          ...
          >
            <button
              ...
              className="flex size-10 items-center justify-center rounded-lg text-[#475569] hover:bg-[#EDF1F7]"
              aria-label="ปีก่อนหน้า"
            >
              <ChevronLeft className="size-5" />
            </button>
            <span className="min-w-24 text-center text-sm font-semibold tabular-nums text-[#0C1B33]">
          ...
          >
            <div className="mb-5 flex items-center justify-between">
              ...
              <button
                ...
                className="flex h-11 w-11 items-center justify-center text-[#64748B]"
                ...
                >
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <span className="shrink-0 text-right text-xs text-[#64748B]">
                      ...
                      <span
                        className={`block text-sm font-bold tabular-nums ${plan.remainingAmount < 0 ? "text-[#B91C1C]" : "text-[#0C1B33]"}`}
                      >
                        {formatBaht(Math.abs(plan.remainingAmount), 0)}
                      </span>
                    </span>
                  </div>
                  <p className="mt-3 text-sm tabular-nums text-[#475569]">
...
function SummaryCard({
  ...
  return (
    <div className="rounded-2xl border border-[#DDE5F0] bg-white p-4 shadow-sm">
