              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
                ...
                <div className="space-y-1.5 sm:col-span-2">
                  <label
                    ...
                    className="font-semibold text-[#1F1A17]"
                  >
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2.5 rounded-2xl border border-[#E4DED7] text-sm text-[#1F1A17] tabular-nums"
                  />
                  <p
                    id="approval-threshold-help"
