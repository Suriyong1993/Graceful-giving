  ...
  return (
    ...
    >
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <div className="bg-gradient-to-r from-[#FFFFFF] via-[#FAF8F5] to-[#EEF1F3] rounded-2xl p-6 border border-[#DCE3E6] shadow-xs flex items-center gap-5">
          <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-2xl overflow-hidden bg-white p-1 border border-[#DCE3E6] shadow-xs shrink-0">
            <Illustration
          ...
          <div className="space-y-1">
            <h2 className="text-lg sm:text-xl font-bold text-[#42515A]">
        ...
        <form
          ...
          className="bg-white rounded-2xl p-6 sm:p-8 border border-[#DCE3E6] card-elevation-sm space-y-6"
        >
          {/* 1. ประเภทถวาย */}
          <div className="space-y-2.5">
            <label className="text-xs font-bold text-[#42515A] block">
              ...
              {categories.map(cat => (
                <button
                  ...
                  className={`p-3 rounded-2xl border text-xs font-bold text-center transition-all ${
                    category === cat.id
                      ? "bg-[#EEF1F3] border-[#225B66] text-[#42515A] shadow-2xs"
                      : "bg-white border-[#DCE3E6] text-[#6A7880] hover:bg-[#FAF8F5]"
                  }`}
                >
                  {cat.label}
                </button>
          ...
          <div className="space-y-2.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="0.00"
                className="w-full pl-12 pr-4 py-3.5 rounded-2xl bg-[#FFFFFF] border border-[#DCE3E6] text-2xl font-bold text-[#1F5C33] focus:outline-none focus:border-[#225B66]"
              />
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full p-3 rounded-2xl bg-[#FFFFFF] border border-[#DCE3E6] text-xs text-[#172128]"
              />
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full p-3 rounded-2xl bg-[#FFFFFF] border border-[#DCE3E6] text-xs text-[#172128] disabled:opacity-50"
              />
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              className="rounded text-[#225B66] focus:ring-[#225B66] w-4 h-4 border-[#DCE3E6]"
            />
            <label
              htmlFor="anon"
              className="text-xs text-[#42515A] cursor-pointer"
            >
          ...
          <button
            ...
            className="w-full py-4 rounded-2xl bg-[#225B66] hover:bg-[#174852] text-white font-bold text-sm button-elevation transition-all flex items-center justify-center gap-2"
          >
      ...
      <Dialog open={isSuccessOpen} onOpenChange={setIsSuccessOpen}>
        <DialogContent className="max-w-sm bg-[#FFFFFF] border-[#DCE3E6] rounded-2xl p-6 text-center text-[#172128] space-y-4">
          <div className="w-20 h-20 mx-auto rounded-2xl overflow-hidden border border-[#DCE3E6] shadow-xs p-1 bg-[#E4F3E7]">
            <Illustration
          ...
          <div>
            <h3 className="text-xl font-bold text-[#42515A]">
          ...
          <div className="p-4 rounded-2xl bg-[#EEF1F3] border border-[#DCE3E6] text-xs text-left space-y-1.5">
            <p className="flex justify-between">
              <span className="text-[#6A7880]">ประเภท:</span>
              <span className="font-bold text-[#42515A]">
            ...
            <p className="flex justify-between">
              <span className="text-[#6A7880]">ช่องทาง:</span>
              <span className="font-medium text-[#42515A]">{method}</span>
            </p>
          </div>
