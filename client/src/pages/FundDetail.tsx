  ...
  return (
    <AppLayout title="รายละเอียดกองทุน" subtitle={fund.name}>
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <section className="bg-[#FFF4DF] border border-[#E9D9BF] rounded-3xl p-6 md:p-8 space-y-6 shadow-sm">
          <div className="flex flex-col md:flex-row md:items-start justify-between gap-6">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <button
                ...
                className="min-h-11 inline-flex items-center gap-2 px-4 py-2.5 rounded-2xl bg-[#E99A4A] text-white text-sm font-medium"
              >
