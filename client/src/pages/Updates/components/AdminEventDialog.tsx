...
export function AdminEventDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[90vh] w-full max-w-lg overflow-y-auto rounded-xl border-line bg-surface p-6 shadow-xs">
          ...
          <div className="mt-5 space-y-4">
            <Field label="ชื่อกิจกรรม">
              <input
                ...
                className="w-full rounded-xl border border-line px-3.5 py-2.5 text-sm text-ink-2 focus:border-brand focus:outline-none"
              />
            </Field>
