  ...
  return (
    <section className="space-y-4">
      <div className="overflow-hidden rounded-2xl border border-[#DDE5F0] bg-white shadow-sm">
            ...
            return (
              <li key={key} className="flex items-center gap-3 p-3 md:p-4">
                ...
                <input
                  ...
                  className="w-24 rounded-xl border border-[#DDE5F0] p-2.5 text-right text-base font-bold tabular-nums text-foreground disabled:opacity-60"
                />
        ...
        <div className="flex items-center justify-between border-t-2 border-[#DDE5F0] bg-background p-4">
          <div>
